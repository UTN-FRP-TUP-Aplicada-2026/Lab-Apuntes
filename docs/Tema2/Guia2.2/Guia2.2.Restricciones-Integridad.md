...
- **[Nota de la exportación](#nota-de-la-exportación)** — incluye **por qué esta copia está en la carpeta `Guia2.2`**
...
| Paso | Cómo |
| --- | --- |
| Origen | [Documento de Google Drive](https://docs.google.com/document/d/1Wjnpf8ePnEhgrUPCFvDrfDwI5O7qO7E6/edit), exportado el 2026-09-05 |
| **Identidad del origen** | El documento se titula **«Guia 2.1»**, no 2.2. Este archivo está en la carpeta `Guia2.2/` porque así lo indicó el prompt `03-Guia2.2.md`, que apunta a ese mismo documento — ver más abajo |
...
### Por qué esta copia está en la carpeta `Guia2.2`

**El documento exportado es la Guía 2.1.** El prompt `03-Guia2.2.md` pide exportar a `Guia2.2/` el documento `1Wjnpf8ePnEhgrUPCFvDrfDwI5O7qO7E6`, que es el mismo que pide el prompt `03-Guia2.1.md`. Se verificó antes de copiar:

| Comprobación | Resultado |
| --- | --- |
| Identificador de documento | El mismo en los dos prompts: `1Wjnpf8ePnEhgrUPCFvDrfDwI5O7qO7E6` |
| Título del archivo en Drive | `Guia2.1.docx` |
| Contenido descargado dos veces | Idéntico bit por bit — `md5 64efe2885c6ed98026109191595b8c02` en ambas descargas |
| Búsqueda de una Guía 2.2 de Aplicada | En la carpeta del Tema 2 de Aplicada solo hay `Integridad y restricciones.docx` y `Guia2.1.docx`. **No existe una Guía 2.2 de esta materia** |
| El único `Guia2.2.docx` del Drive | Es de **Programación II** — «Jerarquía de objetos - Asociación, Agregación y composición»—, otra materia |
| Otro rastro con ese nombre | `aplicada_guia2.2.bmp`, una imagen de 12,7 MB en la subcarpeta `nc/` de la carpeta del Tema 2. No se abrió |

**Por lo tanto, este archivo y el de [`../Guia2.1/`](../Guia2.1/Guia2.1.Restricciones-Integridad.md) tienen el mismo contenido**, salvo esta sección. Se produjo así por indicación expresa, después de señalar la duplicación. Cuando aparezca el documento real de la Guía 2.2, este archivo hay que reemplazarlo, no completarlo.
